...
public class AdministradorUI extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for(int i=0; i < adminController.getListaEmpleados().size();i++){
            DefaultTableModel tblModel = (DefaultTableModel)jTable1.getModel();
            Object[] row = new Object[6];
            row[0]= ((Administrador) adminController.getListaEmpleados().get(i)).getId();
            row[1]= adminController.getListaEmpleados().get(i).getNombre();
            row[2]= adminController.getListaEmpleados().get(i).getSalario();
            row[3]= adminController.getListaEmpleados().get(i).getNumHorasTrabajadas();
